...
const Home: React.FC = () => {
  ...
  const testimonials = [
    {
      text: "단순히 툴 사용법을 넘어서 '어떻게 자동화 업무를 설계해야 하는지'를 배웠습니다. 교육 다음 날 바로 실무에 적용해 보고서 작성 시간을 70% 단축했습니다.",
      name: "김00",
      company: "공공기관",
      title: "기획·운영",
    },
    {
      text: "비전공자인 저희 팀원들이 AI를 두려워하지 않고 자신의 업무 파트너로 인식하게 된 것이 가장 큰 수확입니다.AI를 대하는 인식이 완전히 바뀌었습니다.",
      name: "이00",
      company: "제조업",
      title: "고객지원",
    },
